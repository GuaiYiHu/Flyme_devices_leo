...
.method private readPermissionsFromXml(Ljava/io/File;Z)V
    ...
    .local v3, "allowed":Z
    :goto_6
    const-string/jumbo v29, "android.hardware.consumerir"
    ...
    .line 364
    const-string/jumbo v29, "ro.boot.hwversion"
    ...
    invoke-virtual/range {v29 .. v30}, Ljava/lang/String;->charAt(I)C
    ...
    .line 365
    const-string/jumbo v29, "msm8992"

    const-string/jumbo v30, "ro.product.board"
    ...
    :cond_19
    :goto_7
    const-string/jumbo v29, "android.hardware.nfc"
    ...
    const-string/jumbo v31, "X3 X5 doesn\'t need feature "
    ...
    .line 367
    const-string/jumbo v31, "ro.root.hwversion"
